...
class Search extends React.Component {
  ...
  render() {
    var renderLogos = (
      <div>
        <a href="https://github.com/jakeadelman">
          <img className="logo-img" src="/images/github.svg" alt="git" />
        </a>
        <a href="https://gmail.com/">
          <img className="logo-img" src="/images/google.svg" alt="gisdf" />
        </a>
        <a href="https://twitch.tv/cryptotraderstv/">
          <img className="logo-img" src="/images/twitch.svg" alt="gitds" />
        </a>
        <a href="https://twitter.com/">
          <img className="logo-img" src="/images/twitter.svg" alt="gidt" />
        </a>
      </div>
    );
    ...
    return (
      <div className="impdiv">
        ...
        {this.state.results.length > 0 ? (
          <div className="mappedBack">
            <div className="mapped">{map()}</div>
          </div>
        ) : null}
